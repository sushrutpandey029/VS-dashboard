...
const findPatient = async (req, res) => {
    try {
        ...
        const patient = await patientModel.findOne({ email: email }).select({ _id: 1, DocId: 1, patientFullName: 1, email: 1, phone: 1, disabalityType: 1, createdAt: 0,updatedAt: 0,__v: 0 })
